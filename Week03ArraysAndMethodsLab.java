...
public class Week03ArraysAndMethodsLab {
	...
	public static void main(String[] args) {
       ...
       // System.out.println(array[-1]);
		...
		// method 1 will do something while method 2 will return something;
		// also  can't changes of void type
	...
	private int[] numbers;
	    ...
	    System.out.println(void findSmallestNumber(array));
   ...
   public static  String greet2(String name)   {
	...
	// Method 17:
    public static int findSmalletNumber(int[] numbers)   {
